<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所在学院" prop="suozaixueyuan">
          <el-input v-model="ruleForm.suozaixueyuan" 
              placeholder="所在学院" clearable  :readonly="ro.suozaixueyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所在学院" prop="suozaixueyuan">
              <el-input v-model="ruleForm.suozaixueyuan" 
                placeholder="所在学院" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="志愿时" prop="zhiyuanshi">
          <el-input v-model="ruleForm.zhiyuanshi" 
              placeholder="志愿时" clearable  :readonly="ro.zhiyuanshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="志愿时" prop="zhiyuanshi">
              <el-input v-model="ruleForm.zhiyuanshi" 
                placeholder="志愿时" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="学院信息" prop="xueyuanxinxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="学院信息"
                  v-model="ruleForm.xueyuanxinxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xueyuanxinxi" label="学院信息" prop="xueyuanxinxi">
                    <span>{{ruleForm.xueyuanxinxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='suozaixueyuan'){
            this.ruleForm.suozaixueyuan = obj[o];
	    this.ro.suozaixueyuan = true;
            continue;
          }
          if(o=='shouji'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='xueyuanxinxi'){
            this.ruleForm.xueyuanxinxi = obj[o];
	    this.ro.xueyuanxinxi = true;
            continue;
          }
          if(o=='zhiyuanshi'){
            this.ruleForm.zhiyuanshi = obj[o];
	    this.ro.zhiyuanshi = true;
            continue;
          }
          if(o=='touxiang'){
