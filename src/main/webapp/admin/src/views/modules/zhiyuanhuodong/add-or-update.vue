  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动编号" prop="huodongbianhao">
          <el-input v-model="ruleForm.huodongbianhao" 
              placeholder="活动编号" clearable  :readonly="ro.huodongbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动编号" prop="huodongbianhao">
              <el-input v-model="ruleForm.huodongbianhao" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="活动状态" prop="huodongzhuangtai">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.huodongjieshao = this.ruleForm.huodongjieshao.replace(reg,'../../../ssmj85gg/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
