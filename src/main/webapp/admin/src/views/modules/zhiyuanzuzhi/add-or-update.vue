<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="隶属学院" prop="lishuxueyuan">
          <el-input v-model="ruleForm.lishuxueyuan" 
              placeholder="隶属学院" clearable  :readonly="ro.lishuxueyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="隶属学院" prop="lishuxueyuan">
              <el-input v-model="ruleForm.lishuxueyuan" 
                placeholder="隶属学院" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zuzhimingcheng = true;
          ...
          if(o=='lishuxueyuan'){
            this.ruleForm.lishuxueyuan = obj[o];
	    this.ro.lishuxueyuan = true;
            continue;
          }
          if(o=='fuzeren'){
