<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="申请说明" prop="shenqingshuoming">
          <el-input v-model="ruleForm.shenqingshuoming" 
              placeholder="申请说明" clearable  :readonly="ro.shenqingshuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="申请说明" prop="shenqingshuoming">
              <el-input v-model="ruleForm.shenqingshuoming" 
                placeholder="申请说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zuzhishenqing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zuzhishenqingCrossAddOrUpdateFlag = false;
						 this.parent.search();
